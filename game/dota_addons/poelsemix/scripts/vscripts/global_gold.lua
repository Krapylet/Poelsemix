...
function GiveGoldBig(keys)
	...
	local units = FindUnitsInRadius(caster:GetTeamNumber(), target_location, nil, 3400, DOTA_UNIT_TARGET_TEAM_BOTH, DOTA_UNIT_TARGET_HERO, DOTA_UNIT_TARGET_FLAG_DEAD, 0, false)
